...
begin
  inherited Create;
  // Reference to the global DataModule – assumed to be created and initialized
...
begin
  // Use the global Logger singleton (will be implemented later)
  TLogger.GetInstance.Log(Format('Repository [%s] Error: %s', [AMethod, AMessage]));
end;
